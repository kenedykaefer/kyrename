 ...
 */
std::wstring ky::FileSystemItem::remove_accents(std::wstring const& str)
{
 ...
 */
std::wstring ky::FileSystemItem::to_lower(std::wstring const& str)
{
    std::wstring new_str;
    new_str.reserve(str.size());
 ...
 */
std::wstring ky::FileSystemItem::to_alphanum(std::wstring const& str, wchar_t const separator)
{
    std::wstring new_str;
    new_str.reserve(str.size());
 ...
 */
std::wstring ky::FileSystemItem::normalize_separator(std::wstring const& str, wchar_t const separator, std::wstring const& separators_to_replace)
{
    std::wstring new_str;
    new_str.reserve(str.size());
